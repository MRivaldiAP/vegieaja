...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 mx-auto agen" >
        ...
        <div class="card-body" >
            ...
            <form action="{{url('agen/order/store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row mx-2">
                ...
                <div class="alert alert-warning">
                    <span>Apabila pilihan konsumen tidak tersedia, silahkan tambahkan data konsumen terlebih dahulu di bagian Panel <b>Konsumen</b></span>
                </div>
